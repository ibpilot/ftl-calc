...
| Inputs | Result & WOCL | Departure Window |
|:---:|:---:|:---:|
| ![Duty parameters input screen](assets/screenshot-inputs.png) | ![FDP result with WOCL warning](assets/screenshot-result.png) | ![Departure window check](assets/screenshot-departure.png) |
